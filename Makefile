...
# Generate all
#
all: setup generate_main_docs prepare
	@echo "done."
...
setup:
	...
	git clone --depth 1 --no-single-branch https://github.com/mongodb/node-mongodb-native.git $(4_1)
	git --git-dir $(4_1)/.git --work-tree $(4_1) checkout $(branch_4_1)
...
#
generate_4_1_docs:
	@echo "== Generating 4.1 docs"
	cd $(4_1); npm run build:docs
